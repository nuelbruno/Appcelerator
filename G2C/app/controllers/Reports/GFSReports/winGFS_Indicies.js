...
Ti.API.info('data >>>'+JSON.stringify(args.arrData));
...
var density;
var selectedChartStyle = "GFS_INDICIES PIE";

var chartColor = "";

//$.lblBudgetActivity.text = "Operations - Indicies : " + Alloy.Globals.arrFiveYear[4].year;
...
$.winGFS_Indicies.addEventListener("open", function(e) {
	$.winGFS_Indicies.layout = 'vertical';
