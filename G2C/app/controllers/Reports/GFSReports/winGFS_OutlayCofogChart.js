...
//$.lblBudgetActivity.text = "Budget Execution By Cofog : " + Alloy.Globals.arrFiveYear[4].year;
...
$.winGFS_OutlayCofogChart.addEventListener("open", function(e) {
	$.winGFS_OutlayCofogChart.layout = 'vertical';
...
function changeLanguage() {
	...
	$.lblReprotTitle.text = Alloy.Globals.selectedLanguage.outlaysReportsFunctionsByGovt;//Alloy.Globals.selectedLanguage.dashBoard;
