...
if (Alloy.Globals.isIOS7Plus) {
	...
	$.winGFSReports_List.extendEdges = [Ti.UI.EXTEND_EDGE_TOP];
	$.statusBar.height = 20;
}
...
function closeWindow() {
	Alloy.Globals.closeWindow($.winGFSReports_List);
}
...
$.viewBottomToolbar.getView().addEventListener('click', function(e) {
	if(e.source.buttonId == 'btnFontChange'){
		$.viewBottomToolbar.changeFont($.winGFSReports_List);
		...
		$.viewBottomToolbar.changeTheme($.winGFSReports_List);
	}
});
/**
...
var windowOpened = function(e){
	Alloy.Globals.arrWindows.push($.winGFSReports_List);
...
$.winGFSReports_List.addEventListener("focus", function(e) {
	isClicked = false;
	$.viewBottomToolbar.setDefaultTheme($.winGFSReports_List);
});
$.viewBottomToolbar.setDefaultTheme($.winGFSReports_List);
