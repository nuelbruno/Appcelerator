...
(function(d) {
	...
	function w(f, a, b, c, e, g, d, i) {
		...
		h = h.concat(w(f, a, b, c, e - n / 2, g, d, i))) : ( h = g - e, ["C", f + b * m(e) - b * B * h * l(e) + d, a + c * l(e) + c * B * h * m(e) + i, f + b * m(g) + b * B * h * l(g) + d, a + c * l(g) - c * B * h * m(g) + i, f + b * m(g) + d, a + c * l(g) + i])
	}
	...
	function D(f) {
		if (this.chart.is3d()) {
			...
			a !==
			void 0 && !a && this.group.zIndex !==
			void 0 && this.group.attr({
			...
			d.each(this.data, function(a) {
				if (a.y !== null)
					a = a.pointAttr, this.borderColor = d.pick(b.edgeColor, a[""].fill), a[""].stroke = this.borderColor, a.hover.stroke = d.pick(c.hover.edgeColor, this.borderColor), a.select.stroke = d.pick(c.select.edgeColor, this.borderColor)
			})
		}
	...
	d.wrap(d.Chart.prototype, "init", function(f) {
		...
		if (a[0].chart.options3d && a[0].chart.options3d.enabled)
			b = a[0].plotOptions || {},
			b = b.pie || {}, b.borderColor = d.pick(b.borderColor,
			void 0);
		f.apply(this, a)
	});
	...
	d.wrap(d.Axis.prototype, "init", function(f) {
		var a = arguments;
		if (a[1].is3d())
			a[2].tickWidth = d.pick(a[2].tickWidth, 0), a[2].gridLineWidth = d.pick(a[2].gridLineWidth, 1);
		f.apply(this, [].slice.call(arguments, 1))
	});
		...
		if (this.chart.is3d()) {
			...
			if (d.svg)
				a ? d.each(c.data, function(a) {
					if (a.y !== null && (a.height = a.shapeArgs.height, a.shapey = a.shapeArgs.y, a.shapeArgs.height = 1, !e))
						a.shapeArgs.y = a.stackY ? a.plotY + b.translate(a.stackY) : a.plotY + (a.negative ? -a.height : a.height)
				}) : (d.each(c.data, function(a) {
					if (a.y !== null)
						a.shapeArgs.height = a.height, a.shapeArgs.y = a.shapey, a.graphic && a.graphic.animate(a.shapeArgs, c.options.animation)
	...
	d.wrap(d.Series.prototype, "alignDataLabel", function(d) {
		if (this.chart.is3d() && (this.type === "column" || this.type === "columnrange")) {
			var a = this.chart,
			    ...
			    e = x([e],b.alpha,b.beta*(a.yAxis[0].opposite?-1:1),{x:a.plotWidth/2,y:a.plotHeight/2,z:b.depth,vd:b.viewDistance})[0];
			c.x = e.x;
			c.y = e.y
		}
		d.apply(this, [].slice.call(arguments, 1))
	...
	d.wrap(d.seriesTypes.pie.prototype, "drawPoints", function(f) {
		if (this.chart.is3d()) {
			...
			this.borderColor = a.edgeColor = d.pick(a.edgeColor, a.borderColor,
			void 0);
	...
	if (d.VMLRenderer)
		d.setOptions({
			...
			for (var d,
			    a = this.series.length; a--; )
				d = this.series[a], d.translate(), d.setTooltipPoints && d.setTooltipPoints(), d.render()
		}, d.wrap(d.Axis.prototype, "render", function(d) {
			d.apply(this, [].slice.call(arguments, 1));
