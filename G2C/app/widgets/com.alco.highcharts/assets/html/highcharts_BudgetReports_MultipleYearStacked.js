...
(function() {
	...
	function za(a, b, c, d) {
		var e = M.lang,
		    ...
		    b = c ===
		void 0 ? e.decimalPoint : c,
		    d = d ===
		void 0 ? e.thousandsSep : d,
		    e = a < 0 ? "-" : "",
		...
		for (var c = "{",
			...
			if (d) {
				...
				if (f.length)
					...
					h = M.lang,
					i =
					void 0, /f$/.test(f) ? ( i = ( i = f.match(g)) ? i[1] : -1,
					e = za(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = Xa(f, e)
			}
			j.push(e);
			a = a.slice(c + 1);
			c = ( d = !d) ? "}" : "{"
	...
	function Cb(a, b) {
		...
		for ( g = 0; g < c.length; g++)
			if ( d = c[g],
				e = H[d[0]],
				f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + H[c[g+1][0]]) / 2)
				break;
	...
	function Eb(a, b, c, d) {
		...
		if (t(b)) {
			...
			if (j >= H[Ya])
				i[Fb](j >= H[Qa] ? 0 : k * P(i[ob]() / k));
			if (j >= H[Qa])
				i[Gb](j >= H[sa] ? 0 : k * P(i[pb]() / k));
			if (j >= H[sa])
				i[qb](j >= H[Ra] ? 1 : k * P(i[Sa]() / k));
			j >= H[Ra] && (i[Hb](j >= H[ta] ? 0 : k * P(i[$a]() / k)),
			h = i[ab]());
			j >= H[ta] && (h -= h % k, i[Ib](h));
			if (j === H[Za])
				i[qb](i[Sa]() - i[rb]() + p(d, 1));
			b = 1;
			h = i[ab]();
			for (var d = i.getTime(),
			    l = i[$a](),
			    m = i[Sa](),
			    o = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c; )
		...
		init : function(a, b, c) {
			...
			if (b.length)
				for ( a = c.length; b.length < a; )
					d = [].concat(b).splice(b.length - f, f), e && (d[f - 6] = d[f - 2], d[f - 5] = d[f - 1]),
					b = b.concat(d);
			h && ( b = b.concat(h),
			c = c.concat(i));
			return [b, c]
		...
		N.HighchartsAdapter = N.HighchartsAdapter || a && {
			init : function(b) {
				...
				a.fn.highcharts = function() {
					...
					c = b[0];
					if (c !== v)
						c.chart = c.chart || {}, c.chart.renderTo = this[0], new Highcharts[a](c, b[1]),
						d = this;
	...
	M = {
		...
		lang : {
			...
			decimalPoint : ".",
			numericSymbols : "k,M,B,T,P,E".split(","),// This line is used to show the Amount Values in Appropriate Measures
	...
	va.prototype = {
		...
		attr : function(a, b) {
			...
			if (ea(a))
				...
				q = w(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && ( q = parseFloat(q));
			else {
				for (c in a)
				if ( j = !1,
				d = a[c],
				e = k[c] && k[c].call(this, d, c), e !== !1) {
					e !== v && ( d = e);
					if (c === "d")
						...
						if ( c = "stroke-dasharray",
							...
							if (d) {
								...
								for ( e = d.length; e--; )
									d[e] = A(d[e]) * p(a["stroke-width"], this["stroke-width"]);
								d = d.join(",")
							}
						}
					else if (c === "width")
						...
						e = g.getElementsByTagName("title")[0], e || ( e = z.createElementNS(xa, "title"), g.appendChild(e)), e.textContent =
						d;
					...
					delete this.bBox, this.textStr =
					d, this.added && i.buildText(this)) : j || w(g, c, d)
				}
		...
		css : function(a) {
			...
			if (ra && !Z)
				c &&
				delete a.width, L(this.element, a);
			else {
				for (d in a)
			...
			if (this.added) {
				...
				if (b.tagName === "SPAN") {
					...
					if (r !== this.cTT) {
						t(j) && ( k = j * Ua,
						o = W(k),
						q = ca(k), this.setSpanRotation(j, q, o));
		...
		align : function(a, b, c) {
			...
			if (a) {
				if (this.alignOptions = a, this.alignByTranslate =
					b, !c || ea(c))
					this.alignTo = d = c || "renderer", ga(f, this), f.push(this),
					c = null
			} else
				a = this.alignOptions,
		...
		getBBox : function() {
			...
			if (!a) {
				...
				if (b.isSVG) {
					b = a.width;
					c = a.height;
					if (ra && e && e.fontSize === "11px" && c.toPrecision(3) === "22.7")
						a.height = c = 14;
					if (d)
						a.width = O(c * ca(f)) + O(b * W(f)), a.height = O(c * W(f)) + O(b * ca(f))
				}
				this.bBox = a
			}
			return a
		...
		add : function(a) {
			...
			if (c.handleZ)
				for ( c = 0; c < e.length; c++)
					if ( a = e[c],
					b = w(a, "zIndex"), a !== f && (A(b) > g || !t(g) && t(b))) {
						d.insertBefore(f, a);
						h = !0;
						break
					}
		...
		destroy : function() {
			...
			for (c && n(c, function(b) {
				...
				b = d.parentNode, a.safeRemoveChild(d),
				d =
				b;
		...
		shadow : function(a, b, c) {
			...
			if (a) {
				...
				for ( e = 1; e <= i; e++) {
					...
					if (c)
						w(f, "height", r(w(f, "height") - h, 0)), f.cutHeight =
						h;
	...
	Ga.prototype = {
		...
		buildText : function(a) {
			for (var b = a.element,
			    c = this,
			    d = c.forExport,
			    e = p(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g),
			    f = b.childNodes,
			    g = /style="([^"]+)"/,
			    h = /href="(http[^"]+)"/,
			    i = w(b, "x"),
					...
					if (e !== "" || m.length === 1) {
						...
						if (e !== " " && (n.appendChild(z.createTextNode(e)), p ? o.dx = 0 : o.x = i, w(n, o), !p && f && (!Z && d && L(n, {
							...
							for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "),
								...
								delete a.bBox,
								t = a.getBBox().width,
								o = t > k, !o || e.length === 1 ? ( e = u,
								u = [], e.length && ( n = z.createElementNS(xa, "tspan"), w(n, {
									dy : l || 16,
									x : i
		...
		color : function(a, b, c) {
			...
			if (g) {
				...
				return f.test(a) ? ( e = pa(a), w(b, c + "-opacity", e.get("a")), e.get("rgb")) : (b.removeAttribute(c + "-opacity"), a)
		},
		...
		label : function(a, b, c, d, e, f, g, h, i) {
			function j() {
				...
				V = (Oa ===
				void 0 || E ===
				void 0 || q.styles.textAlign) && p.getBBox();
				...
				if (A) {
					if (!y)
						a = u(-r * da),
						b = h ? -w : 0, q.box = y = d ? o.symbol(d, a, b, q.width, q.height) : o.rect(a, b, q.width, q.height, 0, kb[Rb]), y.add(q);
					y.isImg || y.attr(x({
						width : q.width,
						height : q.height
					}, kb));
			...
			function k() {
				var a = q.styles,
				    ...
				    c;
				c = h ? 0 : w;
				if (t(Oa) && (a === "center" || a === "right"))
					b += {center:0.5,right:1}[a] * (Oa - V.width);
				(b !== p.x || c !== p.y) && p.attr({
					x : b,
					y : c
				});
		...
		Highcharts.VMLElement = D = {
			...
			attr : function(a, b) {
				...
				if (ea(a))
					...
					if ( d = a[c],
					m = !1,
					e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
						e !== v && ( d = e);
						if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
							...
							this[c] = d, c === "x" || c === "y" ? c = {x:"left",y:"top"}[c] : d = r(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d,
							m = !0;
							...
							f.stroked = d ? !0 : !1,
							c = "strokeweight", this[c] =
							d, qa(d) && (d += "px");
						else if (c === "dashstyle")
							(f.getElementsByTagName("stroke")[0]||U(i.prepVML(["<stroke/>"]),null,null,f))[c] = d || "solid", this.dashstyle =
							d,
							m = !0;
						else if (c === "fill")
							if (h === "SPAN")
							...
							this[c] = f.style[c] = d, f.style.left = -u(ca(d * Ua) + 1) + "px", f.style.top = u(W(d * Ua)) + "px";
						else if (c === "translateX" || c === "translateY" || c === "rotation")
							this[c] = d, this.updateTransform(),
							m = !0;
						else if (c === "text")
							this.bBox = null, f.innerHTML =
							d,
							m = !0;
						m || ( eb ? f[c] = d : w(f, c, d))
					}
				...
				if (i) {
					...
					if (c === "fill")
						if (i === "gradient")
							...
							o = m.x2 || m[2] || 0,
							m = m.y2 || m[3] || 0,
							t = 'angle="' + (90 - R.atan((m - a) / (o - c)) * 180 / Ma) + '"', s();
						else {
							var j = m.r,
							    E = j * 2,
							    G = j * 2,
					...
					f = pa(a),
					h = ["<", c, ' opacity="', f.get("a"), '"/>'], U(this.prepVML(h), null, null, b),
					j = f.get("rgb");
				else {
			...
			symbols : {
				...
				rect : function(a, b, c, d, e) {
					var f = a + c,
					    g = b + d,
					    h;
					!t(e) || !e.r ? f = Ga.prototype.symbols.square.apply(0, arguments) : ( h = C(e.r, c, d),
	...
	var Tb;
	if ($)
		Highcharts.CanVGRenderer = D = function() {
	...
	La.prototype = {
		...
		render : function(a, b, c) {
			...
			if (m && r)
				u === "inside" && ( r = -r), d.opposite && ( r = -r),
				b = this.getMarkPath(I, G, r, m * B, g, f), o ? o.animate({
					d : b,
					opacity : c
			...
			if (i && !isNaN(I))
				i.xy = G = this.getLabelPosition(I, G, i, g, k, E, a, s), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? w = !1 : !x && g && k.overflow === "justify" && !this.handleOverflow(a, G) && ( w = !1), s && a % s && ( w = !1), w && !isNaN(G.y) ? (G.opacity = c, i[this.isNew?"attr":
	...
	db.prototype = {
		...
		defaultLabelFormatter : function() {
			...
			if (h)
				...
				for (; f-- && g === v; )
					c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && ( g = za(b / c, -1) + e[f]);
				...
				if (c.visible || !b.options.chart.ignoreHiddenSeries) {
					...
					if (a.isXAxis) {
						if ( e = c.xData, e.length)
							a.dataMin = C(p(a.dataMin, e[0]), Ia(e)), a.dataMax = r(p(a.dataMax, e[0]), ua(e))
					} else {
						d = d.stacking;
						...
						d = c.dataMax;
						c = c.dataMin;
						if (!a.usePercentage && t(c) && t(d))
							a.dataMin = C(p(a.dataMin, c), c), a.dataMax = r(p(a.dataMax, d), d);
						if (t(e))
							if (a.dataMin >= e)
								a.dataMin = e, a.ignoreMinPadding = !0;
							else if (a.dataMax < e)
								a.dataMax = e, a.ignoreMaxPadding = !0
					}
				}
			})
		},
		translate : function(a, b, c, d, e, f) {
			...
			b ? ( a = a * h + i, a -= k,
			a = a / j + d, e && ( a = this.lin2val(a))) : (e && ( a = this.val2lin(a)), f === "between" && ( f = 0.5),
			a = h * (a - d) * j + i + h * k + (qa(f) ? j * f * this.pointRange : 0));
			return a
		},
		...
		getPlotLinePath : function(a, b, c, d) {
			...
			if (isNaN(a))
				...
				if ( h = g,
					j = k - this.bottom, c < f || c > f + this.width)
					m = !0
			} else if ( c = f,
				i = l - this.right, h < g || h > g + this.height)
				m = !0;
		...
		getLogTickPositions : function(a, b, c, d) {
			...
			if (a >= 0.5)
				...
				for (var f = P(b),
					...
					i = e.length;
					for ( h = 0; h < i && !l; h++)
						j = na(fa(f) * e[h]), j > b && (!d || k <= c) && g.push(k), k > c && ( l = !0),
						k =
						j
				}
			else if ( b = fa(b),
				...
				a = mb(a, null, lb(a)),
				g = Na(this.getLinearTickPositions(a, b, c), na), !d)
		...
		setAxisTranslation : function(a) {
			...
			if (this.isXAxis)
				...
				g = this.ordinalSlope && d ? this.ordinalSlope / d : 1, this.minPointOffset = e *= g, this.pointRangePadding = f *= g, this.pointRange = C(c, b), this.closestPointRange =
				d;
			if (a)
				this.oldTransA = h;
		...
		setTickPositions : function(a) {
			...
			c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ja(11, 1)) : (b.min = p(b.userMin, d.min, b.dataMin), b.max = p(b.userMax, d.max, b.dataMax));
			if (e)
				!a && C(b.min, p(b.dataMin, b.min)) <= 0 && ja(10, 1), b.min = ka(na(b.min)), b.max = ka(na(b.max));
			...
			void 0 || b.max ===
			void 0 ? 1 : h && !l && o === b.linkedParent.options.tickPixelInterval ? b.linkedParent.tickInterval : p(l, q ? 1 : (b.max - b.min) * o / (b.len || 1));
			...
			if (!a)
				...
				a = f ? (b.getNonLinearTimeTicks || Eb)(Cb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), b.tickPositions =
				a;
			if (!h)
				e = a[0],
				f = a[a.length - 1],
				h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && a.shift(), d.endOnTick ? b.max = f : b.max + h < f && a.pop(), a.length === 1 && (b.min -= 0.001, b.max += 0.001)
		},
		...
		adjustTickAmount : function() {
			...
			if (c && c[a] && !this.isDatetimeAxis && !this.categories && !this.isLinked && this.options.alignTicks !== !1) {
				...
				if (e < a) {
					for (; b.length < a; )
						b.push(ka(b[b.length - 1] + this.tickInterval));
					this.transA *= (e - 1) / (a - 1);
			...
			if (j || a.isLinked) {
				...
				if (a.horiz && !a.staggerLines && A && !q.rotation) {
					for ( w = a.reversed ? [].concat(e).reverse() : e; x < A; ) {
						...
						for ( q = 0; q < w.length; q++)
							...
							B = q % x, I && ( G = a.translate(G), j[B] !== v && G < j[B] && ( E = !0), j[B] = G + I);
						if (E)
							x++;
						else
							break
				...
				n(e, function(b) {
					if (h === 0 || h === 2 || {1:"left",3:"right"}[h] === a.labelAlign)
						la = r(f[b].getLabelSize(), la)
				});
				if (a.staggerLines)
					la *= a.staggerLines, a.labelOffset =
					la
			} else
		...
		render : function() {
			...
			if (y || f)
				if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b) {
						...
						if (!f || b >= a.min && b <= a.max)
							j[b] || (j[b] = new La(a, b)), r && j[b].isNew && j[b].render(c, !0), j[b].render(c, !1, 1)
					}), q && a.min === 0 && (j[-1] || (j[-1] = new La(a, -1, null, !0)), j[-1].render(-1))), o && n(g, function(b, c) {
						if (c % 2 === 0 && b < a.max)
							l[b] || (l[b] = new tb(a)),
							s = b + q,
							w = g[c + 1] !== v ? g[c + 1] + q : a.max, l[b].options = {
								from : e ? fa(s) : s,
								to : e ? fa(w) : w,
								color : o
			...
			if (p)
				y = a.getLinePath(p), a.axisLine ? a.axisLine.animate({
					d : y
	...
	ub.prototype = {
		...
		refresh : function(a, b) {
			...
			if (l) {
				...
				for ( d = l.length; d--; )
					if ( m = a.series,
						e = m[ d ? "yAxis" : "xAxis"], l[d] && e)
						if ( h = d ? p(a.stackY, a.y) : a.x, e.isLog && ( h = na(h)), m.modifyValue && ( h = m.modifyValue(h)),
							e = e.getPlotLinePath(h, 1), this.crosshairs[d])
	...
	vb.prototype = {
		...
		normalize : function(a) {
			...
			d.pageX === v ? ( c = r(a.x, a.clientX - b.left),
			...
			if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
				...
				for ( i = 0; i < h; i++)
					if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && ( b = c[i].tooltipPoints[k], b.series))
						b._dist = O(k - b.clientX),
						j = C(j, b._dist), e.push(b);
				for ( h = e.length; h--; )
	...
	wb.prototype = {
		init : function(a, b) {
			...
			this.options = b;
			if (b.enabled)
				c.baseline = A(d.fontSize) + 3 + f, c.itemStyle =
				d, c.itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop =
				f, c.padding =
				e, c.initialItemX =
				e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart =
				a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), J(c.chart, "endResize", function() {
		...
		renderItem : function(a) {
			...
			if (!u && (a.legendGroup = d.g("legend-item").attr({
				...
				}), b.colorizeItem(a, a.visible), s && w))
				a.checkbox = U("input", {
					type : "checkbox",
					checked : a.selected,
			...
			if (f && b.itemX - y + e > (o || c.chartWidth - 2 * k - y))
				b.itemX = y, b.itemY += n + b.lastLineHeight + q, b.lastLineHeight = 0;
			...
			f ? b.itemX += e : (b.itemY += n + g + q, b.lastLineHeight =
			g);
		...
		scroll : function(a, b) {
			...
			d > c && ( d = c);
			if (d > 0)
				b !== v && Ka(b, this.chart), this.nav.attr({
					translateX : i,
	...
	xb.prototype = {
		...
		cloneRenderTo : function(a) {
			var b = this.renderToClone,
			    c = this.container;
			a ? b && (this.renderTo.appendChild(c), Ta(b),
			delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), L(b, {
				position : "absolute",
				top : "-9999px",
				display : "block"
		...
		getMargins : function() {
			...
			e = this.axisOffset;
			if (y && !t(g))
				this.plotTop = r(this.plotTop, y + this.options.title.margin + b);
			if (f.display && !k.floating)
				if (q === "right") {
					if (!t(i))
						this.marginRight = r(this.marginRight, f.legendWidth - m + l + c)
				} else if (q === "left") {
					if (!t(h))
						this.plotLeft = r(this.plotLeft, f.legendWidth + m + l + a)
				} else if (u === "top") {
					if (!t(g))
						this.plotTop = r(this.plotTop, f.legendHeight + o + l + b)
				} else if (u === "bottom" && !t(j))
					this.marginBottom = r(this.marginBottom, f.legendHeight - o + l + d);
		...
		setSize : function(a, b, c) {
			...
			if (t(a))
				d.chartWidth = e = r(0, u(a)), d.hasUserSize = !!e;
			if (t(b))
				d.chartHeight = f = r(0, u(b));
			L(d.container, {
				width : e + "px",
				height : f + "px"
			});
		...
		drawChartBox : function() {
			...
			if (k)
				f ? f.animate(u) : this.plotBackground = b.rect(q, p, n, r, 0).attr({
					fill : k
				}).add().shadow(a.plotShadow);
			if (l)
				h ? h.animate(u) : this.plotBGImage = b.image(l, q, p, n, r).add();
			t ? t.animate({
				width : s.width,
				height : s.height
			}) : this.clipRect = b.clipRect(s);
			if (m)
				g ? g.animate(g.crisp(null, q, p, n, r)) : this.plotBorder = b.rect(q, p, n, r, 0, -m).attr({
		...
		linkSeries : function() {
			...
			n(b, function(b) {
				...
				if (ea(d) && ( d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))
					d.linkedSeries.push(b), b.linkedParent =
					d
			})
		},
		render : function() {
		...
		firstRender : function() {
			...
			if (a.isReadyToRender())
				a.getContainer(), K(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), n(b.series || [], function(b) {
					a.initSeries(b)
	...
	Pa.prototype = {
		...
		onMouseOver : function(a) {
			...
			// use this event to send data back..

			//    alert("name =" +this.series.name);
			//    alert("y =" +this.y);

			Ti.App.fireEvent("ChartData", {
				data : this.name.replace("<br/>","")
			});
		...
		update : function(a, b, c) {
			...
			d.firePointEvent("update", {
				...
				if (T(a) && (e.getAttribs(), f))
					a.marker && a.marker.symbol ? d.graphic = f.destroy() : f.attr(d.pointAttr[e.state]);
				g = oa(d, h);
				e.xData[g] = d.x;
		...
		setState : function(a) {
			...
			if (!(a === this.state || this.selected && a !== "select" || e[a] && e[a].enabled === !1 || a && (i || g && !h.enabled))) {
				if (this.graphic)
					e = f && this.graphic.symbolName && m[a].r, this.graphic.attr(x(m[a], e ? {
						x : b - e,
						y : c - e,
						width : 2 * e,
						height : 2 * e
					...
					if (a && h)
						e = h.radius,
						k = k.symbol || d.symbol, j && j.currentSymbol !== k && ( j = j.destroy()), j ? j.attr({
							x : b - e,
							y : c - e
	...
	Q.prototype = {
			...
			if (e)
				if (this.options.connectNulls) {
					...
					n(d, function(c, g) {
						...
						a =
						g) : g === e - 1 && b.push(d.slice(a + 1, g + 1))
					});
			this.segments = b
		},
		setOptions : function(a) {
		...
		getColor : function() {
			...
			if (!e && !a.colorByPoint)
				t(b._colorIndex) ? a = b._colorIndex : (b._colorIndex = d.color,
				a = d.color++),
				e = c[a];
			this.color = e;
		...
		getSymbol : function() {
			...
			if (!this.symbol)
				t(a._symbolIndex) ? a = a._symbolIndex : (a._symbolIndex = c.symbol,
		...
		setData : function(a, b) {
			...
			if (i && m > i) {
				...
				for ( i = 0; i < m; i++)
					if (a[i] !== v && ( d = {
							series : this
						}, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = q ? this.toYData(d) : d.y, l[i] = d.z, h && d.name))
						h[d.x] = d.name;
			ea(k[0]) && ja(14, !0);
			this.data = [];
			this.options.data = a;
		...
		processData : function(a) {
			...
			for ( h = b.length - 1; h >= 0; h--)
				d = b[h] - b[h - 1], d > 0 && (g === v || d < g) ? g = d : d < 0 && this.requireSorting && ja(15);
			this.cropped = f;
			this.cropStart = e;
		...
		generatePoints : function() {
			...
			if (!b && !j)
				...
				b = this.data = b;
			for ( m = 0; m < g; m++)
				i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(ia(e[m]))) : (b[i] ? k = b[i] : a[i] !== v && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] =
				k);
			if (b && (g !== ( c = b.length) || j))
				for ( m = 0; m < c; m++)
					if (m === h && !j && (m += g), b[m])
						b[m].destroyElements(), b[m].plotX =
						v;
			this.data = b;
			this.points = l
		},
		setStackedPoints : function() {
			if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
				...
				for ( q = 0; q < c; q++) {
					...
					j[o] || (j[o] = {});
					if (!j[o][p])
						k[o] && k[o][p] ? (j[o][p] = k[o][p], j[o][p].total = null) : j[o][p] = new Mb(i, i.options.stackLabels, m, p, f, d);
					o = j[o][p];
					m = o.total;
					o.addValue(n || 0);
					o.cacheExtremes(this, [m, m + (n || 0)]);
					if ( typeof n === "number")
						l[g].dataMin = C(l[g].dataMin, o.total, n), l[g].dataMax = r(l[g].dataMax, o.total, n)
				}
				i.oldStacks = {}
			}
		},
		getExtremes : function() {
			...
			if (!t(d) || !t(c)) {
				for ( b = 0; b < i; b++)
					if ( o = g[b],
						f = h[b],
						e = f !== null && f !== v && (!a.isLog || f.length || f > 0),
						o = this.getExtremesFromAll || this.cropped || (g[b + 1] || o) >= m && (g[b - 1] || o) <= l, e && o)
						if ( e = f.length)
							for (; e--; )
								f[e] !== null && (j[k++] = f[e]);
						else
		...
		translate : function() {
			...
			for (var a = this.options,
				...
				if (b && this.visible && n && n[m])
					n = n[m],
					r = n.total, n.cum = q = n.cum - o,
					o = q + o, n.cum === 0 && ( q = p(k, e.min)), e.isLog && q <= 0 && ( q = null), b === "percent" && ( q = r ? q * 100 / r : 0,
					o = r ? o * 100 / r : 0), l.percentage = r ? l.y * 100 / r : 0, l.total = l.stackTotal = r, l.stackY =
					o, n.setOffset(this.pointXOffset || 0, this.barW || 0);
		...
		setTooltipPoints : function(a) {
			...
			if (this.options.enableMouseTracking !== !1) {
				...
				for ( h = 0; h < a; h++) {
					...
					g = b[h + 1];
					c = b[h - 1] ? d + 1 : 0;
					for ( d = b[h + 1] ? C(r(0, P((f.clientX + ( g ? g.wrappedClientX || g.clientX : e)) / 2)), e) : e; c >= 0 && c <= d; )
						i[c++] = f
				}
		...
		animate : function(a) {
			...
			if (a)
				a = c[h],
				e = c[h + "m"], a || (c[h] = a = d.clipRect(s(f, {
					width : 0
			...
			if (l.enabled || this._hasPointMarkers)
				for ( f = b.length; f--; )
					if ( g = b[f],
						...
						m = c.isInsidePlot(u(d), e, c.inverted), a && e !== v && !isNaN(e) && g.y !== null)
						if ( a = g.pointAttr[g.selected ? "select" : ""],
							h = a.r,
	...
	F = ha(Q, {
		...
		getSegments : function() {
			...
			if (this.options.stacking && !this.cropped) {
				...
				n(c, function(a) {
					g[a] ? b.push(g[a]) : ( h = d.translate(a),
					k = f[a].percent ? f[a].total ? f[a].cum * 100 / f[a].total : 0 : f[a].cum,
	...
	D = ha(Q, {
		...
		getColumnMetrics : function() {
			...
			b.grouping === !1 ? i = 1 : n(a.chart.series, function(b) {
				...
				if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
					c.stacking ? ( f = b.stackKey, g[f] === v && (g[f] = i++),
					h = g[f]) : c.grouping !== !1 && ( h = i++), b.columnIndex =
					h
			});
		...
		translate : function() {
			...
			n(this.points, function(a) {
				var b = C(r(-999, a.plotY), d.len + 999),
				    ...
				    b = r(b, c) - s;
				O(b) < f && f && ( b = f,
				s = u(O(s - e) > f ? c - f : e - (d.translate(a.y, 0, 1, 0, 1) <= e ? f : 0)));
				a.barX = n;
				a.pointWidth = g;
				c = O(n) < 0.5;
				t = u(n + t) + j;
		...
		animate : function(a) {
			...
			if (Z)
				a ? (e.scaleY = 0.001,
				a = C(b.pos + b.len, r(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[ d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
		},
		remove : function() {
			var a = this,
			    b = a.chart;
	...
	X = {
		...
		pointClass : ha(Pa, {
			...
			slice : function(a, b, c) {
				...
				if (this.sliced) {
					...
					//	alert("nai hai..karo slice");

					// alert(JSON.stringify(this.options));

					Ti.App.fireEvent("ChartData", {
						data : this.options.name.replace("<br/>","")
					});
				}

				//	alert("slice option = "+this.options);
				...
				//			alert("data ="+JSON.stringify(this.options));

				//			alert("data = "+JSON.stringify(this.options.name));
		...
		generatePoints : function() {
			...
			this.total = b;
			for ( a = 0; a < d; a++)
				e = c[a], e.percentage = b > 0 ? e.y / b * 100 : 0, e.total =
				b
		},
		getCenter : function() {
			var a = this.options,
		...
		drawDataLabels : function() {
			...
			if (a.visible && (e.enabled || a._hasPointLabels)) {
				...
				for ( I = 0; !x && b[I]; )
					x = b[I] && b[I].dataLabel && (b[I].dataLabel.getBBox().height || 21), I++;
				for ( I = 2; I--; ) {
					var b = [],
					    L = [],
					    F = A[I],
					...
					if (l > 0) {
						...
						for ( B = 0; B < J; B++) {
							...
							if (D < B && b[B] !== null)
								...
								for (w < J - B + D && b[B] !== null && ( D = w - J + B); b[D] === null; )
									D++;
							L.push({
								i : D,
								y : b[D]
					...
					for ( B = 0; B < J; B++) {
						...
						if (l > 0) {
							if ( w = L.pop(),
								D = w.i,
								E = w.y, c > E && b[D + 1] !== null || c < E && b[D - 1] !== null)
								E = c
						} else
							E = c;
				...
				if (ua(C) === 0 || this.verifyDataLabelOverflow(C))
					this.placeDataLabels(), t && g && n(this.points, function(b) {
						...
						if (( s = b.dataLabel) && s._pos)
							...
							z = s.connX,
							E = s.connY,
							j = k ? ["M", z + (v[6] === "left" ? 5 : -5), E, "C", z, E, 2 * v[2] - v[4], 2 * v[3] - v[5], v[2], v[3], "L", v[4], v[5]] : ["M", z + (v[6] === "left" ? 5 : -5), E, "L", v[2], v[3], "L", v[4], v[5]], i ? (i.animate({
								d : j
