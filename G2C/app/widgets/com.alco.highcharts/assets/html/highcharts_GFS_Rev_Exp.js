...
(function() {
	...
	M = {
		colors : "#f16645,#ffc65d,#7bc8a4,#3bb5cc,#93648e,#f15c80,#e4d354,#8085e8,#8d4653,#91e8e1".split(","), /// Colorssssssssssssss
	//	colors : "#2f7ed8,#0d233a,#8bbc21,#910000,#1aadce,#492970,#f28f43,#77a1e5,#c42525,#a6c96a".split(","),
		...
		lang : {
			...
			decimalPoint : ".",
			numericSymbols : "k,M,B,T,P,E".split(","),
