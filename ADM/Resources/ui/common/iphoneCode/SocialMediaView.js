function SocialMediaView(){
	...
	var imgYoutube =Ti.UI.createImageView({
		//top :10,
		//left:10,
		image:Ti.App.ResourcePath + 'common/YouTubeicon.png',
		width:30
	...
	var changeLanguage = function(e) {
	  ...
	  if(Ti.App.LanguageId == 1)
      {
      	 ...
      	 facebooktxt.textAlign =Ti.App.textAlign ;
      	 imageYoutube.textAlign = Ti.App.textAlign;
      	 imagtwitter_TXT.textAlign = Ti.App.textAlign;
      	 imgFaceBook.left = 5 ;
      	 imgYoutube.left = 10;
      	 imgTwitter.left = 10;
    	} 
