function ComplainOrSuggestionView(){
	...
	//Contact FOrm
	var scrollingScrollView = Ti.UI.createScrollView({
		contentWidth : 'auto',
		contentHeight : 'auto',
		top : 5,
		left : 5,
	...
	scrollingScrollView.add(scrollView);
	...
	var changeLanguage = function(e) {
	        ...
	        lblFirstname.text = Ti.App.LG('FirstName') + ' *';
			lblLastname.text =  Ti.App.LG('LastName') + ' *';
			lblemail.text = Ti.App.LG('EmailID') + ' *';
			lblphone.text = Ti.App.LG('MobileNumber') + ' *';
			lblSubject.text = Ti.App.LG('Subject');
			lblComments.text = Ti.App.LG('Comments') + ' *';
			lblwarning.text = '* ' + Ti.App.LG('Mandatoryfileds');
			btnsave.title = Ti.App.LG('Submit');
      ...
      else
      {
			...
			lblFirstname.right = GetWidth(22);
			lblLastname.right = GetWidth(22);
			lblemail.right = GetWidth(22);
			lblphone.right = GetWidth(22);
			lblSubject.right =GetWidth(22);
			lblComments.right = GetWidth(22);
			lblwarning.right = GetWidth(22);
      }		
