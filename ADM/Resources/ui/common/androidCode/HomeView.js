function HomeView(){
	...
	var self=Ti.UI.createView({
		top:0,
		left:0,
		backgroundImage:Ti.App.ResourcePath + 'home/blur_bg.png'
	});
	
	var imgLogo=Ti.UI.createImageView({
		top:50,
		align:'center',
		image:Ti.App.ResourcePath + 'home/logo.png',
		width:'80%'
	});
	self.add(imgLogo);
...
var changeLanguage = function(e) {	
	if(Ti.App.LanguageId == 1)
   {
   	  ...
   	  imgMedia.image = Ti.App.ResourcePath + 'home/media.png';
   	  imgServices.image = Ti.App.ResourcePath + 'home/services.png';
   	  imgSocialMedia.image = Ti.App.ResourcePath + 'home/social_media.png';
   	  imgMyLand.image = Ti.App.ResourcePath + 'home/my_land.png';
   	  
   }
   else{
   	  
   	  imgMedia.image = Ti.App.ResourcePath + 'homearabic/media.png';
   	  imgServices.image = Ti.App.ResourcePath + 'homearabic/services.png';
   	  imgSocialMedia.image = Ti.App.ResourcePath + 'homearabic/social_media.png';
   	  imgMyLand.image = Ti.App.ResourcePath + 'homearabic/my_land.png';
   }
};
changeLanguage();
