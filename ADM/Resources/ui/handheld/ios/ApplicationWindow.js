			...
			}else
			{
				Ti.App.ListViewTemplate1={
					...
					},
					{
						...
						bindId: 'arrow',
						properties:{
							image:'images/iphoneimages/common/listing_arrow_ar.png',
							left:5
						}
					}
					]
...
Ti.App.addEventListener('LanguageChanged', changeLanguage);
	...
	Ti.App.Tab1 = tab1;
	self.addTab(tab1);
	homeview.addEventListener("HomeViewItemselected", function(e) { //alert('homeview event called');
		var id = e.id;
		var module = e.module;
		if (module == "Media") {
	...
	// ############## SERVICES calling  from FAQ  AND Calling from HOME VIew############## //
	
	
	 function ServicesViewFun(){
