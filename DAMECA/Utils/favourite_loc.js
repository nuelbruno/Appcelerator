function myfavouritelocation() {

	// ############### fetching results from database for favourite location ##################### //
	//  MAIN VIEW FOR THE PAGE
	var view_favour = Titanium.UI.createView({
		width : "100%",
		height : "auto",
		layout : 'vertical'
...
module.exports = myfavouritelocation;
