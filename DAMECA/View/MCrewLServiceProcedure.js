...
var getMCrewLServiceProcedureView = function() {
	...
	var upperTextView = Ti.UI.createWebView({
		...
		bottom:0,
		left:'2%',
		html:'<html><head><title>HTML Online Editor Sample</title></head><body><table border="0" cellpadding="5"><tbody><tr><td><strong>Service Procedures</strong></td></tr><tr><td><ol><li>Filling the Marine Crew Licensing Application form (Ref. No. LAR-FRM-004-V1)</li><li>Submit all the required documents to issue Marine Craft Crew Licensing</li><li>Submit the applicable fees</li><li>Receive the Marine Craft Crew Licence</li></ol></td></tr></tbody></table></body></html>',
