...
function getMCraftLicensingController() {
	...
	var cls1 = require(Ti.App.getResourceFile('View/MCommercialLNOC1'));
	var view1 = new cls1();
	cls1 = undefined;
	
	var cls2 = require(Ti.App.getResourceFile('View/MCommercialLNOC2'));
	var view2 = new cls2();
	cls2 = undefined;
	
	var cls3 = require(Ti.App.getResourceFile('View/MCommercialLNOC3'));
	var view3 = new cls3();
	cls3 = undefined;
	
	var cls4 = require(Ti.App.getResourceFile('View/MCommercialLNOC4'));
	var view4 = new cls4();
	cls4 = undefined;
